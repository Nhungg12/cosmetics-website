...
$pharmacy_shop_tp_theme_css .='.logo h1 , .logo p a{';
...
//menu font size
$pharmacy_shop_menu_font_size = get_theme_mod('pharmacy_shop_menu_font_size', 14);{
...
$pharmacy_shop_tp_theme_css .='.woocommerce ul.products li.product .onsale{';
    $pharmacy_shop_tp_theme_css .='left: 25px !important;';
$pharmacy_shop_tp_theme_css .='}';
}
