			...
			<div class="col-lg-9 col-md-8">
				<div class="row">
					...
					<div class="col-lg-6 align-self-center">
			            ...
			            <span class="pr-3 timer-text"><?php esc_html_e( 'Ends In', 'pharmacy-shop' ); ?></span><div id="banner-clock" class="time_box" <?php if ( ! empty( get_theme_mod('pharmacy_shop_blockbustor_deals_countdown_timer_date') ) ) { ?>data-date="<?php echo esc_attr(get_theme_mod('pharmacy_shop_blockbustor_deals_countdown_timer_date')); ?>" <?php } ?>>
			                </div>
			              <?php } ?>
			            </div>
					</div>
