...
function pharmacy_shop_logo_width(){

	$pharmacy_shop_logo_width   = get_theme_mod( 'pharmacy_shop_logo_width', 150 );

	echo "<style type='text/css' media='all'>"; ?>
		img.custom-logo{
		    width: <?php echo absint( $pharmacy_shop_logo_width ); ?>px;
		    max-width: 100%;
		}
	<?php echo "</style>";
}

add_action( 'wp_head', 'pharmacy_shop_logo_width' );
